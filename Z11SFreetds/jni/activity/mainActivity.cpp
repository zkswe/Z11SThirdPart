...
static ZKEditText* mEditServerPtr;
static ZKEditText* mEditPasswordPtr;
static ZKTextView* mTextView3Ptr;
static ZKEditText* mEditDBNamePtr;
static ZKButton* mButtonLoginPtr;
static ZKTextView* mTextView4Ptr;
static ZKEditText* mEditUserNamePtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_MAIN_ButtonLogin, onButtonClick_ButtonLogin,
};
/***************/
...
static S_EditTextInputCallback SEditTextInputCallbackTab[] = {
    ID_MAIN_EditServer, onEditTextChanged_EditServer,
    ID_MAIN_EditPassword, onEditTextChanged_EditPassword,
    ID_MAIN_EditDBName, onEditTextChanged_EditDBName,
    ID_MAIN_EditUserName, onEditTextChanged_EditUserName,
};
...
void mainActivity::onCreate() {
    ...
    mEditServerPtr = (ZKEditText*)findControlByID(ID_MAIN_EditServer);if(mEditServerPtr!= NULL){mEditServerPtr->setTextChangeListener(this);}
    mEditPasswordPtr = (ZKEditText*)findControlByID(ID_MAIN_EditPassword);if(mEditPasswordPtr!= NULL){mEditPasswordPtr->setTextChangeListener(this);}
    mTextView3Ptr = (ZKTextView*)findControlByID(ID_MAIN_TextView3);
    mEditDBNamePtr = (ZKEditText*)findControlByID(ID_MAIN_EditDBName);if(mEditDBNamePtr!= NULL){mEditDBNamePtr->setTextChangeListener(this);}
    mButtonLoginPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonLogin);
    mTextView4Ptr = (ZKTextView*)findControlByID(ID_MAIN_TextView4);
    mEditUserNamePtr = (ZKEditText*)findControlByID(ID_MAIN_EditUserName);if(mEditUserNamePtr!= NULL){mEditUserNamePtr->setTextChangeListener(this);}
