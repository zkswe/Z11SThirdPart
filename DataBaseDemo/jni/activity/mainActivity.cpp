...
static ZKEditText* mQueryNameEdittextPtr;
static ZKButton* mQueryButtonPtr;
static ZKListView* mQueryListviewPtr;
static ZKTextView* mTextview3Ptr;
static ZKButton* mInsertButtonPtr;
static ZKEditText* mAgeEdittextPtr;
static ZKEditText* mNameEdittextPtr;
static ZKTextView* mTextview2Ptr;
static ZKTextView* mTextview1Ptr;
static ZKTextView* mTipTextviewPtr;
static ZKWindow* mTipWindowPtr;
static ZKButton* mCreateButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_QueryButton, onButtonClick_QueryButton,
    ID_MAIN_InsertButton, onButtonClick_InsertButton,
    ID_MAIN_CreateButton, onButtonClick_CreateButton,
};
/***************/
...
static S_ListViewFunctionsCallback SListViewFunctionsCallbackTab[] = {
    ID_MAIN_QueryListview, getListItemCount_QueryListview, obtainListItemData_QueryListview, onListItemClick_QueryListview,
};
...
static S_EditTextInputCallback SEditTextInputCallbackTab[] = {
    ID_MAIN_QueryNameEdittext, onEditTextChanged_QueryNameEdittext,
    ID_MAIN_AgeEdittext, onEditTextChanged_AgeEdittext,
    ID_MAIN_NameEdittext, onEditTextChanged_NameEdittext,
};
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mQueryNameEdittextPtr = (ZKEditText*)findControlByID(ID_MAIN_QueryNameEdittext);if(mQueryNameEdittextPtr!= NULL){mQueryNameEdittextPtr->setTextChangeListener(this);}
    mQueryButtonPtr = (ZKButton*)findControlByID(ID_MAIN_QueryButton);
    mQueryListviewPtr = (ZKListView*)findControlByID(ID_MAIN_QueryListview);if(mQueryListviewPtr!= NULL){mQueryListviewPtr->setListAdapter(this);mQueryListviewPtr->setItemClickListener(this);}
    mTextview3Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview3);
    mInsertButtonPtr = (ZKButton*)findControlByID(ID_MAIN_InsertButton);
    mAgeEdittextPtr = (ZKEditText*)findControlByID(ID_MAIN_AgeEdittext);if(mAgeEdittextPtr!= NULL){mAgeEdittextPtr->setTextChangeListener(this);}
    mNameEdittextPtr = (ZKEditText*)findControlByID(ID_MAIN_NameEdittext);if(mNameEdittextPtr!= NULL){mNameEdittextPtr->setTextChangeListener(this);}
    mTextview2Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview2);
    mTextview1Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview1);
    mTipTextviewPtr = (ZKTextView*)findControlByID(ID_MAIN_TipTextview);
    mTipWindowPtr = (ZKWindow*)findControlByID(ID_MAIN_TipWindow);
    mCreateButtonPtr = (ZKButton*)findControlByID(ID_MAIN_CreateButton);
	mActivityPtr = this;
	onUI_init();
